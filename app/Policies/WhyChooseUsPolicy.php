...
class WhyChooseUsPolicy
{
    ...
    {
        return $user->can('force_delete_why::choose::us');
    }
    ...
    {
        return $user->can('force_delete_any_why::choose::us');
    }
    ...
    {
        return $user->can('restore_why::choose::us');
    }
    ...
    {
        return $user->can('restore_any_why::choose::us');
    }
    ...
    {
        return $user->can('replicate_why::choose::us');
    }
