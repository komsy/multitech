...
class HomepagePolicy
{
    ...
    {
        return $user->can('force_delete_homepage');
    }
    ...
    {
        return $user->can('force_delete_any_homepage');
    }
    ...
    {
        return $user->can('restore_homepage');
    }
    ...
    {
        return $user->can('restore_any_homepage');
    }
    ...
    {
        return $user->can('replicate_homepage');
    }
    ...
    {
        return $user->can('reorder_homepage');
    }
}
