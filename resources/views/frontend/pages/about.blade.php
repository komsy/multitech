            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.1s">
                    <div class="about-item-content">
                        <p class="text-uppercase text-warning fs-5 mb-0">{{ $aboutUs->aboutHeading1 }}</p>
                        ...
                        <div class="row gy-0 gx-4 justify-content-between pb-4">
                            <div class="col-lg-6">
                                <p class="text-dark"><i class="fas fa-check text-warning me-1"></i> {!! html_entity_decode ( $aboutUs->aboutPoint1) !!}</p>
                                <p class="text-dark"><i class="fas fa-check text-warning me-1"></i> {!! html_entity_decode ( $aboutUs->aboutPoint2) !!}</p>
                            </div>
                            <div class="col-lg-6">
                                <p class="text-dark"><i class="fas fa-check text-warning me-1"></i> {!! html_entity_decode ( $aboutUs->aboutPoint3) !!}</p>
                                <p class="text-dark mb-0"><i class="fas fa-check text-warning me-1"></i> {!! html_entity_decode ( $aboutUs->aboutPoint4) !!}</p>
                            </div>
                        </div>
                        <a class="btn btn-warning d-inline-block py-3 px-5 me-2 flex-shrink-0 wow fadeInUp" data-wow-delay="0.1s" href="{{ route('about') }}">Discover More</a>
                    </div>
                </div>
            </div>
        </div>
