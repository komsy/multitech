...
<!-- Topbar Start -->
<div class="container-fluid bg-warning text-white d-none d-lg-flex top-section">
...
<div class="container-fluid sticky-top px-0">
    <nav class="navbar navbar-expand-lg navbar-dark bg-light py-3 px-4">
        <a href="" class="navbar-brand p-0">
            <!--<h1 class="text-warning display-6"><i class="fas fa-city text-primary me-3"></i>Multitech</h1>-->
            <img src="{{ asset('images/multii.png')}}" style="width:30%" alt="Logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-none d-xl-flex flex-shirink-0 ml-5">
                ...
                <div class="d-flex flex-column pe-4 border-end">
                    ...
                    <span class="text-warning">Call: {{ $companyDetails->salesNumber ? $companyDetails->salesNumber : $companyDetails->phoneNumber }}
                    </span>
                </div>
            </div>
            <div class="d-flex align-items-center flex-nowrap pt-3  pt-lg-0 ms-lg-2">
                ...
                <a href="{{ route('contact') }}" class="btn btn-warning py-2 px-4 ms-3 flex-wrap flex-sm-shrink-0">Get a Quote</a>
            </div>
